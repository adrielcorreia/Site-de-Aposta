    ...
    return (
        <header className='z-50 bg-gray-100 w-screen p-2 px-8 fixed flex items-center justify-between gap-10'>
            ...
            <div className="flex-1 flex justify-center gap-10">
                <Link color="foreground" href='/events' className="text-black">Eventos</Link>
                <Link color="foreground" href='/mybets' className="text-black">Minhas apostas</Link>
                <Link color="foreground" href='/myevents' className="text-black">Meus eventos</Link>
            </div>
